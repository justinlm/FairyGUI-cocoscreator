...
declare namespace fgui {
    class GRoot extends GComponent {
        ...
        private addChild1;
        addChild(child: GComponent): GObject;
        AddToUI(child: GObject, layer: number): GObject;
        DeleteUI(child: GObject, layer: number, dispose?: boolean): GObject;
        protected onDestroy(): void;
        ...
        showPopup(popup: GComponent, target?: GObject, downward?: any): void;
        togglePopup(popup: GComponent, target?: GObject, downward?: any): void;
        hidePopup(popup?: GObject): void;
        readonly hasAnyPopup: boolean;
        private closePopup;
        showTooltips(msg: string): void;
        showTooltipsWin(tooltipWin: GComponent): void;
        hideTooltips(): void;
        volumeScale: number;
